...
```cmd
$ composer require glitter/k3cloud
```
...
$server = new \Glitter\K3Cloud\K3CloudApiSdk($config)
...
```php
php artisan vendor:publish  --provider="Glitter\K3Cloud\Providers\K3CloudServiceProvider"
